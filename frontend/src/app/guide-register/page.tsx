    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-slate-950 px-4 py-16 overflow-hidden text-white font-sans">
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-slate-400 font-medium tracking-wide uppercase">Tour Guide Network Application</p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-slate-900/40 backdrop-blur-md p-8 shadow-2xl space-y-6">
          {success ? (
            <div className="text-center space-y-5 py-4">
              ...
              <Link 
                href="/" 
                className="inline-block rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 px-6 py-2.5 text-xs font-bold text-slate-950 hover:brightness-110 transition-all shadow-md"
              >
                Return to Gateway
              </Link>
            </div>
            ...
            <>
              <div className="text-center space-y-1">
                <h2 className="text-lg font-bold text-white">Register as Tour Guide</h2>
                <p className="text-3xs text-slate-400">Fill in details below to submit your service registration request.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-4xs font-bold uppercase tracking-wider text-slate-400 mb-1">
                    Specialization (Destinations, Comma Separated)
                  </label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
