...
def run_test():
    print("--- STARTING LOCAL E2E PORTAL FLOW TEST ---")
    ...
    booking_payload = {
        ...
        "travelersCount": 2,
        "roomType": "Suite",
        "specialRequests": "Local E2E Automated test run",
    ...
    print(f"Final Guide Rating: {final_asg['guide']['averageRating']}")

    print("\n--- LOCAL E2E PORTAL FLOW TEST COMPLETED SUCCESSFULLY! ---")
